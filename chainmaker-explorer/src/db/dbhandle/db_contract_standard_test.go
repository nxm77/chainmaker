...
func TestGetEvidenceContract(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				senderAddrs:  []string{"addr1", "addr2"},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, _, err := GetEvidenceContract(tt.args.offset, tt.args.limit, 0, tt.args.chainId, tt.args.contractName, tt.args.txId, "", tt.args.hashList, tt.args.senderAddrs)
