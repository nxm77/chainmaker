...
func TestSetAccountTotalCache(t *testing.T) {
	SetAccountTotalCache(ChainID, 123)
}

func TestGetAccountTotalCache(t *testing.T) {
	_ = GetAccountTotalCache(ChainID)
}

func TestUpdateAccountDataCache(t *testing.T) {
	accountData := &db.Account{
		Address: AccountAddr1,
		TxNum:   123,
	}
	SetAccountDataCache(ChainID, accountData)
	accountData1 := &db.Account{
		Address: AccountAddr1,
		TxNum:   456,
	}
	UpdateAccountDataCache(ChainID, accountData1)
}
