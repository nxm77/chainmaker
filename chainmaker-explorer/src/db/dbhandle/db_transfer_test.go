...
func TestGetFTTransferCount(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, err := GetFTTransferCount(tt.args.chainId, tt.args.contractAddr, tt.args.userAddr)
			if (err != nil) != tt.wantErr {
...
func TestGetNFTTransferCount(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, err := GetNFTTransferCount(tt.args.chainId, tt.args.contractAddr, tt.args.userAddr, tt.args.tokenId)
			if (err != nil) != tt.wantErr {
