...
func insertCrossContractTest1() ([]*db.CrossChainContract, error) {
	...
	err := InsertCrossContract(ChainID, contractList)
...
func TestGetCrossContractByName(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, err := GetCrossContractByName(tt.args.chainId, tt.args.subChainId, tt.args.nameList)
...
func TestInsertCrossContract(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := InsertCrossContract(tt.args.chainId, tt.args.insertList); (err != nil) != tt.wantErr {
