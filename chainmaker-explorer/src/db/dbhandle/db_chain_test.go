...
func TestGetChainInfoById(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, err := GetChainInfoById(tt.args.chainId)
...
func TestGetChainInfoCache(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err := GetChainInfoCache(redisKey)
			if (err != nil) != tt.wantErr {
...
func TestGetChainListByPage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, _, err := GetChainListByPage(tt.args.offset, tt.args.limit, tt.args.chainId)
			if (err != nil) != tt.wantErr {
