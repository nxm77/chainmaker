...
//	@return int64
//	@return error
func GetEventListCount(chainId, contractName, txId string, topics []string) (int64, error) {
...
func GetContractEventList(offset, limit int, chainId, contractName, txId string, topics []string) (
	[]*db.ContractEvent, error) {
...
func GetEventNumByContractName(chainId, contractName string) (int64, error) {
...
func GetABIEventsByVersion(offset, limit int, chainId, contractAddr, contractVersion string) (
	[]*db.ContractEvent, error) {
	contractEvents := make([]*db.ContractEvent, 0)
	if contractAddr == "" {
		return contractEvents, nil
