...
const (
	...
	GetCrossSyncTxDetail = "GetCrossSyncTxDetail"
...
const (
	//CrossModelOther 跨链-普通模式
	CrossModelOther int32 = 0
	//CrossModelSync 跨链-同步模式
	CrossModelSync int32 = 1
)
...
// GetCrossTxDetailParams get
type GetCrossSyncTxDetailParams struct {
	ChainId string
	CrossId string
}

// IsLegal legal
func (params *GetCrossSyncTxDetailParams) IsLegal() bool {
	return params.ChainId != "" && params.CrossId != ""
}
