...
func Test_buildChainInfo(t *testing.T) {
	...
	sampleChainConfig := &ChainConfig{
		...
		UserConf: &UserKeyConf{
			UserSignKeyFilePath: "test-privkey-file",
			UserSignCrtFilePath: "test-cert-file",
		},
	}
	...
	expectedChainInfo := &ChainInfo{
		...
		UserInfo: &UserInfo{
			UserSignKey: "", // 假设 ReadAbsPathFile 返回空字符串
			UserSignCrt: "", // 假设 ReadAbsPathFile 返回空字符串
		},
	}
