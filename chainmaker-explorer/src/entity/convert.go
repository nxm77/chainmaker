...
func bindParamsPost(ctx *gin.Context, body RequestBody) error {
...
// BindGetTxDependenciesHandler bind param
func BindGetTxDependenciesHandler(ctx *gin.Context) *GetTxDependenciesParams {
	var body = &GetTxDependenciesParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
// BindGetQueryTxListHandler bind param
func BindGetQueryTxListHandler(ctx *gin.Context) *GetQueryTxListParams {
	var body = &GetQueryTxListParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
// BindContractVersionsHandler bind param
func BindContractVersionsHandler(ctx *gin.Context) *GetContractVersionsParams {
	var body = &GetContractVersionsParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
// BindVerifyContractCodeHandler bind param
func BindVerifyContractCodeHandler(ctx *gin.Context) *VerifyContractParams {
	var body = &VerifyContractParams{}
	if err := bindParamsPost(ctx, body); err != nil {
		return nil
	}

	// 获取文件
	file, err := ctx.FormFile("ContractSourceFile")
	if err != nil {
		log.Error("Error retrieving file:", err)
		return nil
	}
	body.ContractSourceFile = file
	return body
}

// BindGetDqueryChartHandler bind param
func BindGetDqueryChartHandler(ctx *gin.Context) *GetDqueryChartParams {
	var body = &GetDqueryChartParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
// BindGetDqueryChartHandler bind param
func BindSaveDqueryChartHandler(ctx *gin.Context) *SaveDqueryChartParams {
	var body = &SaveDqueryChartParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
// GetDIDListParams bind param
func BindGetDIDListHandler(ctx *gin.Context) *GetDIDListParams {
	var body = &GetDIDListParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
// BindGetDIDDetailHandler bind param
func BindGetDIDDetailHandler(ctx *gin.Context) *GetDIDDetailParams {
	var body = &GetDIDDetailParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
// GetDIDListParams bind param
func BindGetDIDHistoryHandler(ctx *gin.Context) *GetDIDHistoryParams {
	var body = &GetDIDHistoryParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
// GetDIDListParams bind param
func BindGetVCListHandler(ctx *gin.Context) *GetVCListParams {
	var body = &GetVCListParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
// BindGetVCTemplateHandler bind param
func BindGetVCTemplateHandler(ctx *gin.Context) *GetVCTemplateParams {
	var body = &GetVCTemplateParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
func BindPluginLoginHandler(ctx *gin.Context) *PluginLoginParams {
	var body = &PluginLoginParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
// BindAccountLoginHandler bind param
func BindAccountLoginHandler(ctx *gin.Context) *AccountLoginParams {
	var body = &AccountLoginParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
// BindContractTypesHandler bind param
func BindContractTypesHandler(ctx *gin.Context) *GetContractTypesParams {
	var body = &GetContractTypesParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
	return body
...
// BindUpdateContractNameSWHandler bind param
func BindUploadContractAbiHandler(ctx *gin.Context) *UploadContractAbiParams {
	var body = &UploadContractAbiParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}

	// 获取文件
	file, err := ctx.FormFile("AbiJson")
	if err != nil {
		log.Error("Error retrieving file:", err)
		return nil
	}
...
func BindGetABIDataHandler(ctx *gin.Context) *GetABIDataParams {
	var body = &GetABIDataParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
...
func BindGetContractTopicsHandler(ctx *gin.Context) *GetContractTopicsParams {
	var body = &GetContractTopicsParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
...
func BindGetDecodeContractEventsHandler(ctx *gin.Context) *GetDecodeContractEventsParams {
	var body = &GetDecodeContractEventsParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
...
func BindGetCrossContractCallsHandler(ctx *gin.Context) *GetCrossContractCallsParams {
	var body = &GetCrossContractCallsParams{}
	if err := bindParams(ctx, body); err != nil {
		return nil
	}
